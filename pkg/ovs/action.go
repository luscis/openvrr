...
func (a *pushAction) GoString() string {
	return fmt.Sprintf("ovs.Push(%q)", a.src)
}
...
func (a *pushAction) MarshalText() ([]byte, error) {
	...
	return bprintf("push:%s", a.src), nil
}

func Pop(dst string) Action {
	return &popAction{
		dst: dst,
	}
}
...
func (a *popAction) GoString() string {
	return fmt.Sprintf("ovs.Pop(%q)", a.dst)
}
...
func (a *popAction) MarshalText() ([]byte, error) {
	...
	return bprintf("pop:%s", a.dst), nil
}
